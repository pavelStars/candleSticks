...
struct MonthlyTimeSeries: Decodable {
    let arrayMonthlyTimeSeries: [TimeSeries]
    enum CodingKeys: String, CodingKey {
        case arrayDailyTimeSeries = "Monthly Time Series"
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        do {
            ...
            arrayMonthlyTimeSeries = series
        } catch let error {
            print(error)
            arrayMonthlyTimeSeries = []
        }
    }
}
